...
import { k as n, s as o, C as s, m as u, a as c, b as p, c as v, d, e as l, g as y, f as k } from "./ddbb86ae.mjs";

export { C as CombinedError, f as createRequest, j as getOperationName, a as makeErrorResult, m as makeResult, i as mergeResultPatch, h as stringifyVariables } from "./ddbb86ae.mjs";

import { subscribe as g, share as x, map as b, filter as w, tap as E, merge as O, mergeMap as q, takeUntil as N, make as _, onPush as D, makeSubject as P, onEnd as S, onStart as R, publish as V, take as A, switchMap as M, fromValue as T } from "wonka";
...
var cacheExchange = ({forward: e, client: r, dispatchDebug: t}) => {
  ...
  return o => {
    ...
    }))(e(w((e => "query" !== e.kind || "cache-only" !== e.context.requestPolicy))(b((e => addMetadata(e, {
      cacheOutcome: "miss"
    })))(O([ b(mapTypeNames)(w((e => !shouldSkip(e) && !isOperationCached(e)))(i)), w((e => shouldSkip(e)))(i) ])))));
    return O([ s, u ]);
  };
};
...
var fetchExchange = ({forward: e, dispatchDebug: r}) => t => {
  ...
  var n = q((e => {
    ...
    var s = N(w((e => "teardown" === e.kind && e.key === t))(a))(l(e, o, i));
    if ("production" !== process.env.NODE_ENV) {
      return D((t => {
...
var fallbackExchange = ({dispatchDebug: e}) => r => w((() => !1))(E((r => {
...
var $ = function Client(e) {
  ...
  var makeResultSource = r => {
    var o = w((e => e.operation.kind === r.kind && e.operation.key === r.key && (!e.operation.context._instance || e.operation.context._instance === r.context._instance)))(h);
    if (e.maskTypename) {
      o = b((e => ({
        ...e,
    ...
    return x(S((() => {
      ...
      return O([ T(e), b((() => ({
        ...e,
        stale: !0
      })))(A(1)(w((e => "query" === e.kind && e.key === r.key && "cache-only" !== e.context.requestPolicy))(i))) ]);
    }))(N(w((e => "teardown" === e.kind && e.key === r.key))(i))(o)))));
  };
  ...
  var p = Object.assign(c, {
    ...
    query(e, r, t) {
      ...
      return withPromise(p.executeQuery(k(e, r), t));
    },
    readQuery(e, r, t) {
      var a = null;
      g((e => {
    ...
    subscription: (e, r, t) => p.executeSubscription(k(e, r), t),
    mutation: (e, r, t) => withPromise(p.executeMutation(k(e, r), t))
  });
  var v = noop;
  if ("production" !== process.env.NODE_ENV) {
    var {next: d, source: l} = P();
    p.subscribeToDebugTarget = e => g(e)(l);
    v = d;
  }
